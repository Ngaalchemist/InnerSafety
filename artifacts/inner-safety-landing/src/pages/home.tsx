...
export default function Home() {
  ...
  return (
    <div className="bg-background text-foreground overflow-x-hidden">
      {/* Sticky header/navbar removed per request — hero now opens up with nothing blocking the top */}
      ...
      <section className="relative w-full overflow-hidden bg-background min-h-[100dvh]">
        ...
        <div className="absolute top-0 left-0 w-full z-10 px-[5%] md:px-[6%] pt-8 md:pt-12">
          <div className="max-w-xl">
            ...
            <h1
              className="text-[31px] md:text-[39px] font-serif text-foreground font-bold leading-snug mb-5"
        ...
        {/* Below-ground block — subheadline, bullets, CTA and trust badges start right at the ground line */}
        <div className="absolute left-0 w-full z-10 px-[5%] md:px-[6%]" style={{ top: '44%' }}>
