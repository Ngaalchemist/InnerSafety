  ...
  return (
    <div className="bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative w-full overflow-hidden bg-background min-h-[100dvh]">
        ...
        <div className="absolute left-0 w-full z-10 px-[5%] md:px-[6%]" style={{ top: '52%' }}>
          <div className="max-w-2xl">
            ...
            <ul className="space-y-3 mb-8" style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 400 }}>
              <li className="flex items-center gap-3 text-white whitespace-nowrap text-sm" style={{ textShadow: '0 1px 10px rgba(0,0,0,0.55)' }}>
                ...
                <span><strong className="text-primary font-extrabold" style={{ fontFamily: "'Montserrat', sans-serif" }}>Làm dịu hệ thần kinh</strong> để cơ thể không còn luôn trong trạng thái cảnh giác</span>
              </li>
              <li className="flex items-center gap-3 text-white whitespace-nowrap text-sm" style={{ textShadow: '0 1px 10px rgba(0,0,0,0.55)' }}>
                <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0" />
                <span><strong className="text-primary font-extrabold" style={{ fontFamily: "'Montserrat', sans-serif" }}>Ngủ sâu hơn, bớt overthinking</strong> và lấy lại cảm giác bình yên trong chính mình</span>
              </li>
              <li className="flex items-center gap-3 text-white whitespace-nowrap text-sm" style={{ textShadow: '0 1px 10px rgba(0,0,0,0.55)' }}>
                <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0" />
                <span><strong className="text-primary font-extrabold" style={{ fontFamily: "'Montserrat', sans-serif" }}>Đưa ra quyết định từ sự vững vàng</strong> thay vì phản ứng vì nỗi sợ</span>
              </li>
            </ul>
        ...
        {/* Quote — no background box; placed as plain text directly above the
            baked-in "10%" label in the sky, dark brown for legibility */}
        <div className="hidden lg:block absolute right-[6%] top-[16%] z-10 max-w-[22rem] text-right">
          <p
            className="text-sm font-serif italic leading-relaxed"
            style={{ color: '#5b3a1e', textShadow: '0 1px 10px rgba(255,255,255,0.6)' }}
          >
