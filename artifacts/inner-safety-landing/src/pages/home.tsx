...
export default function Home() {
  ...
  return (
    <div className="bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative w-full overflow-hidden bg-background min-h-[100dvh]">
        <img
          src={heroImg}
          alt="Cây cổ thụ trên vách đất, bộ rễ phát sáng bên dưới"
          className="absolute inset-0 w-full h-full object-cover object-center"
        />

        {/* Headline block — reserves the entire above-ground area of the image */}
        <div className="absolute top-0 left-0 w-full z-10 px-[5%] md:px-[6%] pt-16 md:pt-20">
          <div className="w-full">
            <div
              className="text-primary uppercase tracking-widest text-[13px] md:text-[15px] font-serif font-bold mb-4"
            ...
            >
              ...
              <span className="block text-primary">Nhưng bên trong,</span>
              <span className="block text-primary md:whitespace-nowrap">
        ...
        {/* Below-ground block — subheadline, bullets, CTA and trust badges, given breathing room below the headline */}
        <div className="absolute left-0 w-full z-10 px-[5%] md:px-[6%]" style={{ top: '50%' }}>
          <div className="max-w-2xl">
            ...
            {/* CTA — square, metallic gold, stretched 20% wider toward the roots */}
            <Button 
            ...
            {/* Trust badges — single line, aligned under the button, never wraps */}
            <div
              className="flex flex-nowrap items-center justify-start gap-x-4 mt-5 text-[11px] text-white/90 font-medium whitespace-nowrap"
              style={{ textShadow: '0 1px 8px rgba(0,0,0,0.65)' }}
            >
              <span className="flex items-center gap-1.5"><PlayCircle className="w-3.5 h-3.5 text-primary flex-shrink-0" /> Học online</span>
              <span className="flex items-center gap-1.5"><PlayCircle className="w-3.5 h-3.5 text-primary flex-shrink-0" /> Bắt đầu ngay</span>
              <span className="flex items-center gap-1.5"><Shield className="w-3.5 h-3.5 text-primary flex-shrink-0" /> Có người đồng hành</span>
              <span className="flex items-center gap-1.5"><Lock className="w-3.5 h-3.5 text-primary flex-shrink-0" /> Truy cập trọn đời</span>
              <span className="flex items-center gap-1.5"><Shield className="w-3.5 h-3.5 text-primary flex-shrink-0" /> Hoàn tiền 7 ngày</span>
            </div>
          </div>
        </div>

        {/* Quote — pinned between the baked-in 10% (top) and 90% (bottom) labels in the image, exactly 2 lines */}
        <div className="hidden lg:block absolute right-[6%] z-10 max-w-[24rem]" style={{ top: '42%', transform: 'translateY(-50%)' }}>
          <div className="bg-[#0f0b08]/55 backdrop-blur-[2px] rounded-xl px-5 py-4">
            <p className="text-white text-sm font-serif italic leading-relaxed">
              <span className="block whitespace-nowrap">"Bình an không được xây từ những gì xảy ra bên ngoài.</span>
              <span className="block whitespace-nowrap">Nó được nuôi dưỡng từ bộ rễ bên trong."</span>
            </p>
          </div>
        </div>
      </section>
...
function Navbar({ onRegisterClick }: { onRegisterClick: () => void }) {
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-transparent py-4 md:py-5">
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div
          className="font-serif font-bold text-base flex items-center gap-2 text-foreground"
          style={{ textShadow: '0 1px 8px rgba(255,255,255,0.65)' }}
        >
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium">
          <div className="flex gap-6 text-foreground/90" style={{ textShadow: '0 1px 8px rgba(255,255,255,0.65)' }}>
