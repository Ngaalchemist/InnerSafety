  ...
  return (
    <div className="bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative w-full overflow-hidden bg-background min-h-[100dvh] flex flex-col">
        ...
        {/* Top-left copy block */}
        <div className="relative z-10 w-full flex-1 flex flex-col justify-start pt-10 md:pt-14 px-[5%] md:px-[6%]">
          <div className="max-w-xl">
            ...
            <h1
              className="text-2xl md:text-3xl font-serif text-foreground font-bold leading-snug mb-5"
            ...
            >
              ...
              <span className="text-primary">Nhưng bên trong,</span><br/>
              <span className="text-primary">bạn vẫn chưa thật sự</span>{' '}
            ...
            >
              <span className="text-primary font-extrabold">Inner Safety Experience™</span>{' '}
              <span className="text-white">là hành trình 7 ngày giúp bạn tái thiết cảm giác an toàn từ gốc rễ, để cơ thể thôi phản ứng vì sợ hãi và bạn có thể sống từ sự bình an thay.</span>
            </p>
            <ul className="space-y-3 mb-8">
              <li className="flex items-start gap-3 text-white" style={{ textShadow: '0 1px 10px rgba(0,0,0,0.55)' }}>
                <CheckCircle2 className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                <span><strong className="text-primary font-extrabold">Làm dịu hệ thần kinh</strong> để cơ thể không còn luôn trong trạng thái cảnh giác</span>
              </li>
              <li className="flex items-start gap-3 text-white" style={{ textShadow: '0 1px 10px rgba(0,0,0,0.55)' }}>
                <CheckCircle2 className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                <span><strong className="text-primary font-extrabold">Ngủ sâu hơn, bớt overthinking</strong> và lấy lại cảm giác bình yên trong chính mình</span>
              </li>
              <li className="flex items-start gap-3 text-white" style={{ textShadow: '0 1px 10px rgba(0,0,0,0.55)' }}>
                <CheckCircle2 className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                <span><strong className="text-primary font-extrabold">Đưa ra quyết định từ sự vững vàng</strong> thay vì phản ứng vì nỗi sợ</span>
              </li>
            </ul>

            {/* CTA — square, metallic gold, stretched wide toward the roots */}
            <Button 
              onClick={scrollToRegister}
              className="w-full max-w-[420px] h-14 rounded-md text-primary-foreground text-lg font-bold tracking-wide border border-[#f5dfa0]/60 transition-all hover:scale-[1.02]"
              style={{
            ...
            {/* Trust badges — centered under the button, not full width */}
            <div
              className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 mt-5 max-w-[420px] text-xs text-white/90 font-medium"
              style={{ textShadow: '0 1px 8px rgba(0,0,0,0.65)' }}
            >
              <span className="flex items-center gap-1.5"><PlayCircle className="w-3.5 h-3.5 text-primary" /> Học online</span>
              <span className="flex items-center gap-1.5"><PlayCircle className="w-3.5 h-3.5 text-primary" /> Bắt đầu ngay</span>
              <span className="flex items-center gap-1.5"><Shield className="w-3.5 h-3.5 text-primary" /> Có người đồng hành</span>
              <span className="flex items-center gap-1.5"><Lock className="w-3.5 h-3.5 text-primary" /> Truy cập trọn đời</span>
              <span className="flex items-center gap-1.5"><Shield className="w-3.5 h-3.5 text-primary" /> Hoàn tiền 7 ngày</span>
            </div>
          </div>
        </div>

        {/* 10% / 90% stat callouts — right side, matching the sample */}
        <div className="hidden lg:block absolute right-[6%] top-[30%] z-10 text-right">
          <span className="block text-4xl font-serif text-primary" style={{ textShadow: '0 1px 10px rgba(255,255,255,0.6)' }}>10%</span>
          <span className="block text-xs text-foreground/80 max-w-[11rem] mt-1" style={{ textShadow: '0 1px 8px rgba(255,255,255,0.6)' }}>
            Những gì người khác nhìn thấy ở bạn.
          </span>
        </div>
        <div className="hidden lg:block absolute right-[6%] top-[54%] z-10 text-right">
          <span className="block text-4xl font-serif text-primary" style={{ textShadow: '0 1px 10px rgba(0,0,0,0.5)' }}>90%</span>
          <span className="block text-xs text-white/85 max-w-[11rem] mt-1" style={{ textShadow: '0 1px 8px rgba(0,0,0,0.6)' }}>
            Những gì thực sự quyết định cuộc đời bạn.
          </span>
        </div>

        {/* Quote — 2 lines only, dark translucent box, sits lower near the roots */}
        <div className="hidden lg:block absolute right-[6%] top-[72%] z-10 max-w-[19rem]">
          <div className="bg-[#0f0b08]/55 backdrop-blur-[2px] rounded-xl px-5 py-4">
...
function Navbar({ onRegisterClick }: { onRegisterClick: () => void }) {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-background/90 backdrop-blur-md border-b border-border shadow-sm py-2' : 'bg-background/70 backdrop-blur-sm py-2.5'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="font-serif font-bold text-base flex items-center gap-2 text-foreground">
