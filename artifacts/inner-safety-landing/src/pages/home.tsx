    ...
    <div className="bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative w-full overflow-hidden bg-background min-h-[100dvh] flex flex-col">
        ...
        {/* Above-ground zone — eyebrow + headline own this entire area (roughly
            up to the horizon in the photo), sized up ~30% from before */}
        <div className="relative z-10 w-full min-h-[46vh] md:min-h-[48vh] flex flex-col justify-center px-[5%] md:px-[6%] pt-6">
          <div className="max-w-2xl">
            <div
              className="uppercase tracking-widest text-xs font-bold mb-4"
              style={{ color: '#8a6a1f', textShadow: '0 1px 10px rgba(255,255,255,0.7)' }}
            >
              Inner Safety Experience™
            </div>
            <h1
              className="text-3xl md:text-4xl lg:text-5xl font-serif text-foreground font-bold leading-snug"
              style={{ textShadow: '0 2px 18px rgba(255,255,255,0.55)' }}
            >
              Sau một biến cố...<br/>
              <span className="text-primary">cuộc sống của bạn có thể đã tiếp tục.</span><br/>
        ...
        {/* Below-ground zone — subheadline + bullets + CTA + badges start right
            at the horizon */}
        <div className="relative z-10 w-full px-[5%] md:px-[6%] pb-10 md:pb-14">
          <div className="max-w-2xl">
            <p
              className="text-lg font-semibold mb-8 max-w-lg"
              style={{ textShadow: '0 1px 12px rgba(0,0,0,0.5)' }}
            >
              <span className="text-primary font-extrabold" style={{ fontSize: '1.2em' }}>Inner Safety Experience™</span>{' '}
              <span className="text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>là hành trình 7 ngày giúp bạn tái thiết cảm giác an toàn từ gốc rễ, để cơ thể thôi phản ứng vì sợ hãi và bạn có thể sống từ sự bình an thay.</span>
            </p>
            <ul className="space-y-3 mb-8" style={{ fontFamily: "'Montserrat', sans-serif" }}>
        ...
        {/* Quote — anchored right at the horizon (trunk-to-root junction), with a
            small connector line so it visually grows out from the trunk instead of
            floating in the sky */}
        <div className="hidden lg:flex absolute right-[6%] top-[47%] -translate-y-1/2 z-10 items-center gap-0 max-w-[20rem]">
