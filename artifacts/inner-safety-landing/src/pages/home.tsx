      ...
      <section className="relative w-full overflow-hidden bg-background min-h-[100dvh]">
        ...
        <div className="absolute top-0 left-0 w-full z-10 px-[5%] md:px-[6%] pt-16 md:pt-20">
          <div className="w-full">
            <div
              className="uppercase tracking-widest text-[13px] md:text-[15px] font-serif font-bold mb-4"
        ...
        {/* Quote — anchored right at the horizon (trunk/root junction), with a
            horizontal connector growing out from the trunk toward the box */}
        <div className="hidden lg:flex absolute right-[6%] z-10 items-center max-w-[24rem]" style={{ top: '49%', transform: 'translateY(-50%)' }}>
